...
from darts.models import RandomForestModel as RF
from darts import TimeSeries

#Constantes
TRIALS = 400
STUDY_NAME = "rf-temporal-3"
NUM_FOLDS = 10
SEMENTE_ALEATORIA = 352


# Ler dados
df = pd.read_csv("Dataset-REAL-OFICIAL-Covid-1.csv", sep=',')
...
def val_cruzada(modelo, folds, target_treino, covariates):
    ...
    if train_len < 1 or test_len < 1:
        # print(f"Erro: série muito curta ({total_len}) para {folds} folds com proporção 90/10.")
        return
