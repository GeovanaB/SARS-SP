...
#Constantes
TRIALS = 400
STUDY_NAME = "lstm-temporal-3"
NUM_FOLDS = 10
SEMENTE_ALEATORIA = 352


# Ler dados
df = pd.read_csv("../../../dados/Dataset-REAL-OFICIAL-Covid-1.csv", sep=',')
...
def cria_instancia_modelo(trial):
    ...
    parametros = {
        ...
        "input_chunk_length": trial.suggest_int("input_chunk_length", 10, 60),
    ...
    model = BlockRNNModel(**parametros, optimizer_kwargs = {"lr": lr}, pl_trainer_kwargs = {"accelerator": "gpu"})
